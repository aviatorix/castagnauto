...
document.querySelectorAll('.btn-view').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        alert('Funzionalità di visualizzazione dettagli - Da implementare secondo le tue esigenze');
    });
});
...
// Attiva l'effetto typing quando la pagina è caricata
document.addEventListener('DOMContentLoaded', () => {
...
console.log('Template AutoLux caricato correttamente! 🚗✨');
